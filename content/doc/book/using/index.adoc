...
about Jenkins usage which is outside the scope of the core Jenkins feature:
Pipeline.

If you want to create and configure a Pipeline project through a `Jenkinsfile`
or you wish to find out more about this core Jenkins
feature, refer to the relevant topics within the
link:../pipeline[Pipeline] chapter.
